...
3. New Blog
  ...
  - Cloudflare Pages staging is connected and Giscus comments are working on the preview deployment.
...
- Cut `enderjones.com` from the old Cloudflare Pages project to the new one.
- Preserve the old repo state, then archive or disable the old GitHub Pages deployment.
